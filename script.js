...
function cursorAnimation(){
    document.addEventListener("mousemove",function(dets){
     ...
     //Magnet Effect using Sherryjs of Nav-part2 h4...
...
function footerTextAnimation(){
    ...
    textanimie.addEventListener('mouseenter', function() {
        gsap.to('#footer h1', {
            delay: 0.5,
            duration: 1,
            onStart: function() {
    ...
    textanimie.addEventListener('mouseleave', function() {
